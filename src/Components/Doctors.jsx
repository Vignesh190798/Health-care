      ...
      <div className=" flex flex-col items-center justify-between mb-10 lg:mb-0">
        <div>
          ...
          <p className=" mt-2 text-center lg:text-center">
            ...
            professionals. Our doctors are committed to providing quality care,
            trusted advice, and support tailored to your needs. Whether it's a
            routine check-up or ongoing guidance, we're here to help you stay
